    ...
    <div class="bg-gray-100">
        <div class="mt-20 max-w-6xl mx-auto px-4 py-8">
            ...
            <div class="text-sm text-gray-500">
                <a href="#" class="hover:underline">Home</a> / <span class="text-gray-800 font-medium">Akun
                    Saya</span>
            </div>
            ...
            <div class="mt-6 flex">
                ...
                <div class="w-1/4 bg-white shadow rounded p-6">
                    <ul class="space-y-4">
                        <!-- Menu Profil -->
                        <li>
                            <button onclick="showContent('profil')"
                        ...
                        <li>
                            <button onclick="showContent('alamat')"
                                class="flex items-center space-x-3 text-gray-600 hover:text-blue-600">
                                <div class="flex items-center justify-center w-6 h-6">
                        ...
                        <li>
                            <button onclick="showContent('orders')"
                                ...
                                <div class="flex items-center justify-center w-6 h-6">
                                    <i class="fas
            fa-shopping-cart text-gray-600 text-lg"></i>
                                </div> <span>Pesanan</span>
                            </button>
                        </li>
                        <li> <button onclick="showContent('notifications')"
                                class="flex items-center space-x-3 text-gray-600 hover:text-blue-600">
                                <div class="flex items-center justify-center w-6 h-6"> <i
                                        class="fas fa-bell text-gray-600 text-lg"></i> </div> <span>Notifikasi</span>
                            </button> </li>
                        <li> <button onclick="openLogoutModal()"
                                class="flex items-center space-x-3 text-gray-600 hover:text-blue-600">
                                <div class="flex items-center justify-center w-6 h-6"> <i
                                        class="fas fa-sign-out-alt text-gray-600 text-lg"></i> </div> <span>Keluar
                                    Akun</span>
                            </button> </li>
                    </ul>
                ...
                <div class="w-full lg:w-3/4 ml-6">
                    ...
                    <div id="profil" class="content-section bg-white shadow rounded-lg p-6">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-500 mt-1 mb-4">Kelola informasi profil Anda untuk mengontrol,
                                melindungi dan mengamankan akun</p>

                            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
                                <div>
                                    <label for="username" class="text-sm font-medium text-gray-700">Username</label>
                                    <input type="text" id="username" placeholder="Masukkan nama depan Anda"
                                        class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:ring-blue-500 focus:border-blue-500 text-sm">
                                </div>
                                <div>
                                    <label for="name" class="text-sm font-medium text-gray-700">Nama</label>
                                    <input type="text" id="second-name" placeholder="Masukkan nama belakang Anda"
                                        class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:ring-blue-500 focus:border-blue-500 text-sm">
                                </div>
                            </div>
                                ...
                                <div>
                                    ...
                                    <div class="relative mt-1">
                                        <input type="date" id="birth-date"
                                            class="block w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:ring-blue-500 focus:border-blue-500 text-sm">
                                    </div>
                                </div>
                                <div>
                                    <label for="no-hp" class="text-sm font-medium text-gray-700">Nomor Hp</label>
                                    <input type="text" id="no-hp" placeholder="Masukkan nomor hp"
                                        class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:ring-blue-500 focus:border-blue-500 text-sm">
                                    <p class="text-xs text-gray-400 mt-1">Perhatikan: format tanpa spasi dan tanda hubung.
                                    </p>
                                </div>
                            </div>
                            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
                                ...
                                <button type="submit"
                                    class="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-1 text-sm">
                                    Simpan
                                </button>
                            </div>
                        </div>
                    ...
                    <div id="alamat" class="content-section hidden bg-white shadow rounded-lg p-6">
                        ...
                        <form>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" id="nama-penerima" placeholder="Masukkan nama penerima"
                                    class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:ring-blue-500 focus:border-blue-500 text-sm">
                            </div>
                            ...
                            <!-- Alamat Lengkap -->
                            <div class="mb-4">
                                <label for="alamat-lengkap" class="text-sm font-medium text-gray-700">Alamat
                                    Lengkap</label>
                                <textarea id="alamat-lengkap" rows="3" placeholder="Masukkan alamat lengkap"
                                    class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:ring-blue-500 focus:border-blue-500 text-sm"></textarea>
                            </div>
                            ...
                            <table class="w-full bg-white border border-gray-200 rounded-lg shadow-sm">
                                <thead class="bg-gray-100">
                                    <tr class="border-b border-gray-300">
                                        ...
                                        <th class="py-3 px-4 text-left text-sm font-semibold text-gray-700">Tanggal Pesan
                                        </th>
                                    ...
                                    <tr class="border-b hover:bg-gray-50 transition-all">
                                        ...
                                        <td class="py-3 px-4 text-sm text-gray-800 flex items-center w-[300px]">
                                            <img src="https://images.unsplash.com/photo-1686831889330-b059693080dd?q=80&w=1974&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                                                alt="Produk Tepache" class="w-12 h-12 mr-3 rounded" />
                                            LuxeFoam Sesderma
                                        </td>
                                    ...
                                    <tr class="border-b hover:bg-gray-50 transition-all">
                                        ...
                                        <td class="py-3 px-4 text-sm text-gray-800 flex items-center w-[300px]">
                                            <img src="https://images.unsplash.com/photo-1598300056393-4aac492f4344?q=80&w=2034&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                                                alt="Produk Tepache Madu" class="w-12 h-12 mr-3 rounded" />
                                            ErgoChair Flex
                                        </td>
                ...
                <div id="notifications" class="content-section bg-white shadow rounded-lg p-6 hidden">
                    ...
                    <div class="flex justify-between items-center mb-4">
                        ...
                        <button class="text-sm text-blue-500 hover:text-blue-700" onclick="markAllAsRead()">Tandai Semua
                            Dibaca</button>
                    </div>
                    ...
                    <div class="bg-gray-100 p-4 rounded-lg shadow-sm mb-3">
                        ...
                        <div class="mt-2">
                            <span
                                class="bg-blue-100 text-blue-800 text-xs font-semibold py-1 px-3 rounded-full">Baru</span>
                        </div>
                    </div>
                    ...
                    <div class="bg-gray-100 p-4 rounded-lg shadow-sm mb-3">
                        ...
                        <div class="mt-2">
                            <span
                                class="bg-yellow-100 text-yellow-800 text-xs font-semibold py-1 px-3 rounded-full">Peringatan</span>
                        </div>
                    </div>
                    ...
                    <div class="bg-gray-100 p-4 rounded-lg shadow-sm mb-3">
                        ...
                        <div class="mt-2">
                            <span
                                class="bg-red-100 text-red-800 text-xs font-semibold py-1 px-3 rounded-full">Kesalahan</span>
                        </div>
                    </div>
                    ...
                    document.addEventListener('DOMContentLoaded', function() {
                        ...
                        statusFilter.addEventListener('change', function() {
                            ...
                            orderRows.forEach(row => {
                                const orderStatus = row.querySelector('td:nth-child(4)').innerText
                                    .toLowerCase();
                                if (selectedStatus === 'all' || orderStatus.includes(selectedStatus
                                    ...
                                    row.style.display =
                                        'none'; // Menyembunyikan baris pesanan yang tidak sesuai
                                }
                            });
                        });
