...
<body class="bg-black flex items-center justify-center min-h-screen">
    ...
    <div class="relative z-10 w-full max-w-md mx-auto">
        ...
        <div class="bg-white p-8 shadow-lg rounded-lg mb-8">
            ...
            <p class="text-gray-600 mb-4">Enter your username and password below to log in.</p>
            <form method="POST" action="{{ route('login') }}">
                @csrf
                <div class="mb-4">
                    <input class="w-full p-3 border border-gray-300 rounded" placeholder="Username" type="text"
                ...
                <div class="mb-4 relative">
                    <input id="password" class="w-full p-3 border border-gray-300 rounded pr-10" placeholder="Password"
                ...
                <div class="flex justify-end items-center mb-4">
                    ...
                    before:content-[''] before:absolute before:bottom-0 before:left-0 before:w-full before:h-[2px] before:bg-black before:scale-x-0 before:origin-center hover:before:scale-x-100 before:transition-transform before:duration-300"
                            href="{{ route('password.request') }}" aria-haspopup="dialog" aria-expanded="false"
                            aria-controls="radix-:Redrh9:" data-state="closed">
                            Forgot Password
                        </a>
                    @endif
                </div>
