        ...
        <div class="row">
            ...
            @foreach ($products as $product)
                <div class="col-6 col-md-4 col-lg-3 mb-4 d-flex">
                    <div class="product-item flex-fill" data-name="{{ $product['name'] }}" data-price="Rp {{ number_format($product['price'], 0, ',', '.') }}" data-description="{{ $product['description'] }}">
                        <img src="{{ $product['image'] }}" alt="{{ $product['name'] }}" class="img-fluid">
                        <h5 class="product-name text-center mt-2">{{ $product['name'] }}</h5>
                        <p class="product-price text-center">Rp {{ number_format($product['price'], 0, ',', '.') }}</p>
