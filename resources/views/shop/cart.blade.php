...
<style>
    ...
    .info-container p {
        font-size: 0.875rem; /* Ukuran font isi teks */
...
<div class="cart-page">
    ...
    <div class="info-container">
        <h4><i class="fas fa-truck" style="margin-right: 8px;"></i><strong>Informasi Pengiriman</strong></h4>
            <p>Pengiriman dilakukan melalui layanan ekspedisi terpercaya. Estimasi waktu pengiriman adalah 3-5 hari kerja untuk wilayah Jabodetabek dan 5-10 hari kerja untuk wilayah lainnya. Gratis ongkir untuk pembelian di atas Rp 100.000.</p>
        ...
        <p>Pengembalian produk dapat dilakukan dalam waktu 3 hari setelah barang diterima, dengan syarat barang dalam kondisi baik dan belum digunakan. Silakan hubungi layanan pelanggan kami untuk informasi lebih lanjut terkait proses pengembalian.</p>
    </div>
...
<script>
    function updateTotalPrice() {
        ...
        document.querySelector('.total-price strong').innerText = 'Total: Rp ' + total.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ".");
    }
